...
export default function ShipmentsError({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-24 text-center">
      ...
      <div>
        <h2 className="text-sm font-bold text-[var(--text-primary)] mb-1">خطأ في تحميل الشحنات</h2>
        <p className="text-xs text-[var(--text-muted)]">تعذّر الاتصال بقاعدة البيانات. تحقق من إعدادات Supabase.</p>
      </div>
